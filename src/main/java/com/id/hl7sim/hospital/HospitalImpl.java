...
public class HospitalImpl implements Hospital {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.id.hl7sim.hospital.Hospital#setCapacity(java.util.concurrent.atomic.
	 * AtomicInteger)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.id.hl7sim.hospital.Hospital#setOccupiedBeds(java.util.concurrent.atomic.
	 * AtomicInteger)
	 */
	@Override
	...
	public void admitPatient() {
		System.out.println("Inpatients: " + getOccupiedBeds());
